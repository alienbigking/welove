var vm = new Vue({
    ...
    methods: {
        ...
        list_6: function () {
            ...
            let yinghuaContainer = document.getElementById('yinghuaContainer')
            yinghuaContainer.style.display = 'none'
            let aixingid = document.getElementById('aixing')
            aixingid.style.display = 'block'
            // 爱心
            xingtuan()
            aixing()
            xingkong()
